    ...
    <div className='flex h-full flex-col overflow-y-auto'>
      ...
      <div className='space-y-6 p-4'>
        <div className='space-y-4'>
          ...
          <div className='border-border bg-card/60 flex items-center justify-between rounded-lg border p-3'>
            <div className='space-y-0.5'>
              <label className='text-sm leading-none font-medium'>Enable Waiting Room</label>
        ...
        <div className='space-y-4'>
          ...
          <div className='flex flex-col gap-2 pt-2'>
            <div className='flex items-center justify-between'>
              <label className='text-sm leading-none font-medium'>Turn on their microphone</label>
              <Switch
                checked={allowAudio}
                onCheckedChange={(checked) =>
                  updatePermission('allow_audio', checked, !checked ? 'audio' : undefined)
                }
              />
            </div>
            <p className='text-muted-foreground text-[10px] leading-relaxed'>
              If turned off, participants cannot turn on their microphone. Hosts can still turn on
              their microphone.
            </p>
          </div>
          ...
          <div className='flex flex-col gap-2 pt-2'>
            <div className='flex items-center justify-between'>
              <label className='text-sm leading-none font-medium'>Turn on their video</label>
              <Switch
                checked={allowVideo}
                onCheckedChange={(checked) =>
                  updatePermission('allow_video', checked, !checked ? 'video' : undefined)
                }
              />
            </div>
            <p className='text-muted-foreground text-[10px] leading-relaxed'>
