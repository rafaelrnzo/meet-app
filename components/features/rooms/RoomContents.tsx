        ...
        <div className='mb-2'>
          <div className='my-4'>
            ...
            <div className='flex items-center justify-between gap-2'>
              <InputGroup className='has-[[data-slot][aria-invalid=true]]:[&>input]:text-error flex max-h-11 w-full items-center gap-2 rounded-md border border-neutral-400 px-3 py-[7.5px] shadow-sm has-[[data-slot][aria-invalid=true]]:border-red-200 has-[[data-slot][aria-invalid=true]]:bg-red-200'>
                <InputGroupInput
