...
const badgeVariants = cva(
  'inline-flex items-center rounded-lg border px-2 py-1 text-sm transition-colors italic font-normal focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
