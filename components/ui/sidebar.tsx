...
const SIDEBAR_WIDTH_MOBILE = '21.875rem'
  ...
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-semibold data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground [&>svg]:size-4 [&>svg]:shrink-0 px-2.5 group-data-[collapsible=icon]:justify-center whitespace-normal cursor-pointer',
  {
    variants: {
      variant: {
        ...
        primary:
          'text-neutral-400 hover:bg-neutral-50 hover:text-red-800 data-[active=true]:bg-red-800 data-[active=true]:text-neutral-50 data-[active=true]:hover:bg-red-800 data-[active=true]:hover:text-neutral-50',
        destructive:
          'bg-red-200 text-error hover:text-error hover:bg-red-300 active:bg-error active:text-neutral-50',
      },
      size: {
        default: 'h-8 text-sm',
        sm: 'h-7 text-xs',
        lg: 'h-11 text-sm group-data-[collapsible=icon]:size-11! [&>svg]:size-4.5',
      },
    },
    defaultVariants: {
      variant: 'default',
