...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex w-full items-center rounded-md border border-neutral-400 shadow transition-[color,box-shadow] outline-none dark:bg-input/30",
        ...
        'font-normal text-neutral-950 disabled:bg-slate-300 disabled:text-slate-600 text-md tracking-normal ',
